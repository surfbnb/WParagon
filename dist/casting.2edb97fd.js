...
},{"../helpers/typeof":"node_modules/@babel/runtime/helpers/typeof.js"}],"node_modules/@babel/runtime/helpers/interopRequireDefault.js":[function(require,module,exports) {
...
},{"./objectWithoutPropertiesLoose":"node_modules/@babel/runtime/helpers/objectWithoutPropertiesLoose.js"}],"node_modules/tslib/tslib.es6.js":[function(require,module,exports) {
"use strict";
...
},{"./lib/rng":"node_modules/uuid/lib/rng-browser.js","./lib/bytesToUuid":"node_modules/uuid/lib/bytesToUuid.js"}],"node_modules/@aragon/rpc-messenger/dist/signals.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.default = exports.COMPLETE = void 0;
var COMPLETE = Symbol("RPC_COMPLETE");
exports.COMPLETE = COMPLETE;
var _default = {
  COMPLETE: COMPLETE
};
exports.default = _default;
},{}],"node_modules/@aragon/rpc-messenger/dist/jsonrpc.js":[function(require,module,exports) {
"use strict";
...
var _v = _interopRequireDefault(require("uuid/v4")),
    _signals = _interopRequireDefault(require("./signals"));

var encodeRequest = function encodeRequest(method) {
...
var encodeResponse = function encodeResponse(id) {
  var result = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var response = {
    jsonrpc: "2.0",
    id: id
  };
  return result instanceof Error ? response.error = result.message || "An error occurred" : result === _signals.default.COMPLETE ? response.completed = !0 : response.result = result, response;
};

exports.encodeResponse = encodeResponse;

var isValidResponse = function isValidResponse(response) {
  return !!response && "2.0" === response.jsonrpc && "string" == typeof response.id && (void 0 !== response.result || void 0 !== response.error || void 0 !== response.completed);
};
...
exports.default = _default;
},{"@babel/runtime/helpers/interopRequireDefault":"node_modules/@babel/runtime/helpers/interopRequireDefault.js","uuid/v4":"node_modules/uuid/v4.js","./signals":"node_modules/@aragon/rpc-messenger/dist/signals.js"}],"node_modules/@aragon/rpc-messenger/dist/providers/Provider.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@aragon/rpc-messenger/dist/providers/MessagePortMessage.js":[function(require,module,exports) {
"use strict";
...
var MessagePortMessage = /*#__PURE__*/function (_Provider$default) {
  _inherits(MessagePortMessage, _Provider$default);

  var _super = _createSuper(MessagePortMessage);
  ...
  */
  ...
  function MessagePortMessage() {
    ...
    _this = _super.call(this), _this.target = target, _this.messages$ = (0, _rxjs.fromEvent)(_this.target, "message", !1).pipe( // We can't use event.source in WebWorker messages as it seems to be null
...
},{"@babel/runtime/helpers/interopRequireDefault":"node_modules/@babel/runtime/helpers/interopRequireDefault.js","./Provider":"node_modules/@aragon/rpc-messenger/dist/providers/Provider.js","rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"node_modules/@aragon/rpc-messenger/dist/providers/WindowMessage.js":[function(require,module,exports) {
"use strict";
...
var WindowMessage = /*#__PURE__*/function (_Provider$default) {
  _inherits(WindowMessage, _Provider$default);

  var _super = _createSuper(WindowMessage);
  ...
  */
  function WindowMessage() {
    ...
    _this = _super.call(this), _this.target = target, _this.messages$ = (0, _rxjs.fromEvent)(window, "message", !1).pipe((0, _operators.filter)(function (event) {
...
},{"@babel/runtime/helpers/interopRequireDefault":"node_modules/@babel/runtime/helpers/interopRequireDefault.js","./Provider":"node_modules/@aragon/rpc-messenger/dist/providers/Provider.js","rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"node_modules/@aragon/rpc-messenger/dist/providers/DevMessage.js":[function(require,module,exports) {
"use strict";
...
var DevMessage = /*#__PURE__*/function (_Provider$default) {
  _inherits(DevMessage, _Provider$default);

  var _super = _createSuper(DevMessage);
  ...
  */
  function DevMessage(id, target, bus) {
    ...
    _this = _super.call(this), _this.id = id, _this.target = target, _this.bus = bus;
    return _this;
  }
...
},{"@babel/runtime/helpers/interopRequireDefault":"node_modules/@babel/runtime/helpers/interopRequireDefault.js","./Provider":"node_modules/@aragon/rpc-messenger/dist/providers/Provider.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"node_modules/@aragon/rpc-messenger/dist/index.js":[function(require,module,exports) {
"use strict";
...
var _operators = require("rxjs/operators"),
    _rxjs = require("rxjs"),
    _jsonrpc = _interopRequireDefault(require("./jsonrpc")),
    ...
    */
    ...
    value: function sendAndObserveResponses(method) {
      ...
      return (0, _rxjs.defer)(function () {
        var id = _this.send(method, params);

        return _this.responses().pipe((0, _operators.filter)(function (message) {
          return message.id === id;
        }), // End stream once we've been notified that it's complete
        (0, _operators.takeWhile)(function (response) {
...
},{"@babel/runtime/helpers/interopRequireDefault":"node_modules/@babel/runtime/helpers/interopRequireDefault.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js","rxjs":"node_modules/rxjs/_esm5/index.js","./jsonrpc":"node_modules/@aragon/rpc-messenger/dist/jsonrpc.js","./providers/MessagePortMessage":"node_modules/@aragon/rpc-messenger/dist/providers/MessagePortMessage.js","./providers/WindowMessage":"node_modules/@aragon/rpc-messenger/dist/providers/WindowMessage.js","./providers/DevMessage":"node_modules/@aragon/rpc-messenger/dist/providers/DevMessage.js","./signals":"node_modules/@aragon/rpc-messenger/dist/signals.js"}],"node_modules/@aragon/api/dist/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.debug = debug, exports.getIconBySize = getIconBySize;

function debug() {
  var _console;

  "production" !== "development" && (_console = console).debug.apply(_console, arguments);
} // Get the best icon for the given size.
// Set size to -1 to get the largest one, or to 0 to get the smallest one.


function getIconBySize(icons) {
  var size = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
  // Collect the sizes and sort them
  var sizes = icons.map(function (icon, i) {
    var width = parseInt(icon.sizes.split("x")[1], 10);
  ...
  var iconIndex = (sizes.find(function (iconSize) {
    return iconSize[1] >= size;
  }) || sizes[sizes.length - 1])[0];
  return icons[iconIndex];
}
},{}],"node_modules/@aragon/api/dist/index.js":[function(require,module,exports) {
"use strict";
...
function decorateAppWithIcons(_ref) {
  ...
  return app.icon = function () {
    var size = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : -1;
    var icon = (0, _utils.getIconBySize)(icons, size);
    if (icon && icon.src) return icon.src;
  }, app;
}
/**
...
var AppProxy = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(AppProxy, [{
    ...
    */
    ...
    key: "installedApps",
    value: function installedApps() {
      return this.rpc.sendAndObserveResponses("get_apps", ["observe", "all"]).pipe((0, _operators.pluck)("result"), (0, _operators.map)(function (apps) {
        return apps.map(decorateAppWithIcons);
      }));
    }
    /**
    * DEPRECATED
    ...
    */
    ...
    key: "requestPath",
    value: function requestPath(path) {
    ...
    */
    ...
    key: "emitTrigger",
    value: function emitTrigger(name, data) {
    ...
    */
    ...
    key: "searchIdentities",
    value: function searchIdentities(searchTerm) {
    ...
    */
    ...
    key: "describeTransaction",
    value: function describeTransaction(transaction) {
    ...
    */
    ...
    value: function external(address, jsonInterface) {
      ...
      var eventsInterface = jsonInterface.filter(function (item) {
        return "event" === item.type;
      }),
          contract = {
        events: function events() {
          var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return _this.rpc.sendAndObserveResponses("external_events", [address, eventsInterface, "allEvents", options]).pipe((0, _operators.pluck)("result"));
        },
        pastEvents: function pastEvents() {
          var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          return _this.rpc.sendAndObserveResponse("external_past_events", [address, eventsInterface, "allEvents", options]).pipe((0, _operators.pluck)("result"));
        }
      },
          callMethods = jsonInterface.filter(function (item) {
        return "function" === item.type && item.constant;
      });
      callMethods.forEach(function (methodJsonDescription) {
        contract[methodJsonDescription.name] = function () {
          for (var _len3 = arguments.length, params = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
            params[_key3] = arguments[_key3];
          }

          return _this.rpc.sendAndObserveResponse("external_call", [address, methodJsonDescription].concat(params)).pipe((0, _operators.pluck)("result"));
        };
      }); // Bind non-call (ie. "write") methods for external intents

      var intentMethods = jsonInterface.filter(function (item) {
        return "function" === item.type && !item.constant;
      });
      return intentMethods.forEach(function (methodJsonDescription) {
        contract[methodJsonDescription.name] = function () {
          for (var _len4 = arguments.length, params = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
            params[_key4] = arguments[_key4];
          }

          return _this.rpc.sendAndObserveResponse("external_intent", [address, methodJsonDescription].concat(params)).pipe((0, _operators.pluck)("result"));
        };
      }), contract;
    }
    /**
    ...
    */
    ...
    value: function store(reducer) {
      ...
      var wrappedReducer = function wrappedReducer(_ref3, event) {
        var state = _ref3.state;
        return (0, _rxjs.from)( // Ensure a promise is returned even if the reducer returns an array or throws
        new Promise(function (resolve) {
          return resolve(reducer(state, event));
          ...
          throw console.error("Error from app reducer on event", err), console.error("Current event", event), console.error("Current state", state), err;
        }));
      },
          getCurrentEvents = function getCurrentEvents(fromBlock) {
        return (0, _rxjs.merge).apply(void 0, [_this2.events({
          fromBlock: fromBlock
        })].concat(_toConsumableArray(externals.map(function (_ref4) {
          ...
          getPastEvents = function getPastEvents(cachedFromBlock, toBlock) {
        return (0, _rxjs.merge).apply(void 0, [_this2.pastEvents({
          fromBlock: cachedFromBlock,
          toBlock: toBlock
        })].concat(_toConsumableArray(externals.map(function (_ref5) {
          var contract = _ref5.contract,
              initializationBlock = _ref5.initializationBlock;
        ...
        (0, _operators.flatMap)(function (pastEvents) {
          return (0, _rxjs.from)(pastEvents);
          ...
          cacheValue$ = this.getCache("CACHED_STATE_KEY").pipe( // ensure we always get at least an empty object instead of falsy
      (0, _operators.map)(function (v) {
        return v || {};
      })),
          latestBlock$ = this.web3Eth("getBlockNumber"),
          initState$ = init ? cacheValue$.pipe((0, _operators.switchMap)(function (_ref6) {
        var state = _ref6.state;
        // Make sure `init()` gets a new copy of the cached state so that it doesn't
        // accidentally manipulate the observable's object
        var initialState = state ? _objectSpread({}, state) : null;
        return (0, _rxjs.from)(init(initialState));
      }), (0, _operators.delayWhen)(function (initState) {
        return (0, _utils.debug)("- store - init state:", initState), _this2.cache("state", initState);
      })) : (0, _rxjs.from)([null]),
          store$ = (0, _rxjs.forkJoin)(cacheValue$, initState$, latestBlock$).pipe((0, _operators.switchMap)(function (_ref7) {
        ...
        var cachedState = cacheValue.state,
            cachedBlock = cacheValue.block,
            initialStoreState = (init ? initState : cachedState) || null;
        (0, _utils.debug)("- store - initial store state", initialStoreState), (0, _utils.debug)("- store - cachedBlock ".concat(cachedBlock, " | latestBlock: ").concat(latestBlock)); // The block up to which to fetch past events.
        // The reduced state up to this point will be cached on every load

        var pastEventsToBlock = _Mathmax(0, latestBlock - 100);

        void 0 === cachedBlock ? (0, _utils.debug)("- store - pastEvents: initialization block -> ".concat(pastEventsToBlock, " (up to ").concat(pastEventsToBlock, " blocks)")) : (0, _utils.debug)("- store - pastEvents: block ".concat(cachedBlock, " -> ").concat(pastEventsToBlock, " (").concat(pastEventsToBlock - cachedBlock, " blocks)")), (0, _utils.debug)("- store - currentEvents$: block ".concat(pastEventsToBlock, " -> future"));
        var events$ = (0, _rxjs.concat)( // Past events
        (0, _rxjs.defer)(function () {
          return getPastEvents(cachedBlock, pastEventsToBlock);
        }), // Current events
        (0, _rxjs.defer)(function () {
          // Fetch current events from block after cached block
          var currentEvents$ = getCurrentEvents(pastEventsToBlock + 1),
              accounts$ = _this2.accounts().pipe((0, _operators.map)(function (accounts) {
            return {
          ...
          return (0, _rxjs.merge)(currentEvents$, accounts$);
            ...
            eventsWithTriggers$ = (0, _rxjs.merge)(events$, _this2.triggers());
        ...
        (0, _operators.tap)( /*#__PURE__*/function () {
          var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref9) {
            var state, _ref9$lastEvent, lastEvent;

            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    state = _ref9.state, _ref9$lastEvent = _ref9.lastEvent, lastEvent = _ref9$lastEvent === void 0 ? {} : _ref9$lastEvent;
                    ...
                    _context.prev = 3;
                    _context.next = 6;
                    return _this2.cache("CACHED_STATE_KEY", {
        ...
        (0, _operators.throttleTime)(1e3, _rxjs.asyncScheduler, {
          leading: !1,
          trailing: !0
        }), // Use concatMap to ensure state is saved in the correct order
        (0, _operators.concatMap)( /*#__PURE__*/function () {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return _this2.cache("state", state).toPromise();
...
var api_1 = __importDefault(require("@aragon/api"));

var api = new api_1.default();
console.log('frrf'); // Sends an intent to the wrapper that we wish to invoke `increment` on our app's smart contract

api.increment(1).subscribe(function (txHash) {
  return console.log("Success! Incremented in tx " + txHash);
}, function (err) {
  return console.log("Could not increment: " + err);
});
},{"@aragon/api":"node_modules/@aragon/api/dist/index.js"}],"../../../Users/aligu/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../Users/aligu/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","casting.ts"], null)
//# sourceMappingURL=/casting.2edb97fd.js.map